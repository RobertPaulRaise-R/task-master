        ...
        <div className="m-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="border-light-300 rounded-lg border px-4 py-6">
                <div className="flex justify-between gap-2">
                    ...
                    />
                    <Button btn="primary" onClick={handleSearch}>Search</Button>
                </div>
                            ...
                            <Button
                                ...
                                onClick={
                                    searchResult.requestDirection === "received"
                                        ? () => handleAcceptFriendRequest(searchResult.friend._id)
                    ...
                    {requests && requests.length > 0 ? (
                        requests.map((request) => (
                            <div className="flex items-center justify-between">
                                ...
                                <Button btn="primary" onClick={() => handleAcceptFriendRequest(request._id)}>
                                    Accept
                                </Button>
                            </div>
                        ))
